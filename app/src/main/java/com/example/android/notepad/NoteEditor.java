...
public class NoteEditor extends Activity implements View.OnClickListener {
    ...
    private void findview() {
        ...
        clock = (Button) findViewById(R.id.edit_clock);
        lock = (Button) findViewById(R.id.edit_lock);
        color = (Button) findViewById(R.id.edit_color);
        title = (Button) findViewById(R.id.edit_title);
        sort = (Button) findViewById(R.id.edit_sort);
        ...
        switch (v.getId()) {
            ...
            case R.id.edit_lock:
                ...
                if(flag==0) {
                    ...
                    locked=0;
                    Toast.makeText(this,"note unlock",Toast.LENGTH_LONG).show();
                    lock.setText("lock");
                }
                break;
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            int colLockIndex = mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_LOCK);
            int lock = mCursor.getInt(colLockIndex);
            this.locked=lock;
            if(lock==0){
                this.lock.setText("lock");
            }
            else{
                this.lock.setText("unlock");
            }
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        values.put(NotePad.Notes.COLUMN_NAME_LOCK,locked);
